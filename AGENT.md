...
- Codex: `.codex/skills/` if generated
- Claude Code: `.claude/skills/` if generated
- Gemini: `skills/` if generated
- OpenCode: `.opencode/skills/` if generated
...
GEMINI.md                         → Gemini CLI entry point (generated by `make setup`)
.opencode/AGENTS.md               → OpenCode entry point (generated by `make setup`)
